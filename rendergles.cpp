...
RenderGLES::~RenderGLES()
{
	printf("RenderGLES destructor runs.\n");	
	context_deinit();	
}
...
struct __drm_fb *RenderGLES::drmFBGetFromBO(struct gbm_bo *bo) {
	struct __drm_fb *fb = (struct __drm_fb*) gbm_bo_get_user_data(bo);
...
void RenderGLES::context_deinit(){
	printf ("Deinit KMS....\n");
	// Free EGL stuff
